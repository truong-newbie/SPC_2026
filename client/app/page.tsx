    ...
    loading: () => (
        <div className="flex items-center justify-center min-h-[40vh]">
            <div className="text-center space-y-3">
                ...
                <p className="text-xs text-slate-400">Đang khởi tạo P2P DataChannel...</p>
            </div>
        </div>
    ),
});
...
const SwarmTransfer = dynamic(() => import('@/components/SwarmTransfer'), {
    ...
    loading: () => (
        <div className="flex items-center justify-center min-h-[40vh]">
            <div className="text-center space-y-3">
                <div className="h-10 w-10 border-2 border-cyan-400 border-t-transparent rounded-full animate-spin mx-auto" />
                <p className="text-xs text-slate-400">Đang nạp bộ điều phối Swarm Tracker...</p>
            </div>
        </div>
    ),
});
...
const StoredTransfer = dynamic(() => import('@/components/StoredTransfer'), {
    ...
    loading: () => (
        <div className="flex items-center justify-center min-h-[40vh]">
            <div className="text-center space-y-3">
                <div className="h-10 w-10 border-2 border-cyan-400 border-t-transparent rounded-full animate-spin mx-auto" />
                <p className="text-xs text-slate-400">Đang nạp mô-đun Zero-Knowledge E2EE...</p>
            </div>
        </div>
    ),
});
        ...
        <div className="flex flex-col min-h-screen">
            ...
            <header className="sticky top-0 z-40 w-full border-b border-white/[0.06] bg-[#05070d]/80 backdrop-blur-xl">
                <div className="max-w-6xl mx-auto px-4 sm:px-6 h-16 flex items-center justify-between">
                    ...
                    >
                        <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-cyan-500 via-blue-600 to-indigo-600 p-[1px] shadow-glow transition-transform group-hover:scale-105">
                        ...
                        <div>
                            <div className="flex items-center gap-2">
                                ...
                                <span
                                    className="text-[10px] font-mono font-medium px-2 py-0.5 rounded-full bg-cyan-500/10 text-cyan-300 border border-cyan-500/30"
                            ...
                            <p className="text-[11px] text-slate-400 hidden sm:block">
                                Direct Peer-to-Peer &amp; Zero-Knowledge E2EE Transfer
                            </p>
                        </div>
                    </button>

                    {/* Quick Action: Switch to Transfer Tool */}
                    <div className="flex items-center gap-3">
                        <button
                            onClick={() => switchTab('transfer')}
                            className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-xl text-xs font-semibold text-cyan-300 bg-cyan-500/10 hover:bg-cyan-500/20 border border-cyan-500/30 transition-all active:scale-95"
                        >
                            <span className="w-2 h-2 rounded-full bg-emerald-400 animate-pulse"></span>
                            <span>Sẵn sàng truyền file</span>
                        </button>
                    </div>
                </div>
            </header>
            ...
            {/* MAIN CONTENT AREA */}
            <main className="flex-1 max-w-4xl mx-auto w-full px-4 sm:px-6 pt-8 pb-16">
                {/* =================================================================== */}
                    ...
                    <section className="space-y-8 animate-fadeIn">
                        ...
                        <div className="text-center space-y-3">
                            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full text-xs font-medium bg-cyan-500/10 text-cyan-400 border border-cyan-500/20">
                                ...
                                Zero-Knowledge &amp; P2P WebRTC Direct Data Channel
                            </div>
                            <h1 className="text-3xl sm:text-4xl font-extrabold tracking-tight text-white leading-tight">
                                Chuyển Tệp Siêu Tốc &amp; Bảo Mật Tuyệt Đối
                            </h1>
                        ...
                        <div className="flex justify-center">
                            <div className="inline-flex p-1.5 rounded-2xl bg-slate-900/90 border border-white/10 shadow-lg">
                                <button
                        ...
                        <div className="glass-card rounded-2xl p-6 sm:p-8 space-y-6 shadow-2xl relative">
                            {transferMode === 'p2p' ? (
                                <P2PTransfer />
                            ) : transferMode === 'swarm' ? (
                                <SwarmTransfer />
                            ...
                            {/* Information Badges */}
                            <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 pt-6 border-t border-white/5 text-xs text-slate-400">
                                <div className="flex items-center gap-2">
                                    <span className="w-2 h-2 rounded-full bg-cyan-400"></span>
                                    <span>Không cần tài khoản hay đăng nhập</span>
                                </div>
                                <div className="flex items-center gap-2">
                                    <span className="w-2 h-2 rounded-full bg-emerald-400"></span>
                                    <span>Mã hóa WebCrypto đầu cuối</span>
                                </div>
                                <div className="flex items-center gap-2">
                                    <span className="w-2 h-2 rounded-full bg-purple-400"></span>
                                    <span>Tốc độ tối đa đường truyền mạng</span>
                                </div>
                            </div>
                        </div>
                    </section>
                ...
                {activeTab === 'about' && (
                    <section className="space-y-12 animate-fadeIn">
                        <div className="space-y-4">
                            ...
                            <p className="text-lg text-cyan-300/90 font-medium">
                        ...
                        <div className="space-y-6 text-slate-300 text-base leading-relaxed">
                            ...
                            <div className="glass-card p-6 sm:p-8 rounded-2xl border-l-4 border-l-cyan-400 my-8 shadow-glow">
                                <h3 className="text-lg font-bold text-white mb-2">Kỷ nguyên &ldquo;Khai thác dữ liệu người dùng&rdquo;</h3>
                                ...
                                <blockquote className="italic text-cyan-300 text-base font-medium">
                                    &ldquo;Sự riêng tư không phải là một đặc quyền xa xỉ. Đó là quyền cơ bản của mỗi con người trong kỷ nguyên số.&rdquo;
                                </blockquote>
                            </div>

                            <h2 className="text-2xl font-bold text-white pt-4">Lời đáp trả từ FileBridge</h2>
                            <p>
                        ...
                        <div className="space-y-4 pt-4">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                                <div className="glass-card p-6 rounded-2xl space-y-3">
                                    ...
                                    <h4 className="text-base font-bold text-white">Peer-to-Peer (P2P)</h4>
                                ...
                                <div className="glass-card p-6 rounded-2xl space-y-3">
                                    ...
                                    <h4 className="text-base font-bold text-white">Pure Quality (100%)</h4>
                                    <p className="text-xs text-slate-400 leading-relaxed">
                                ...
                                <div className="glass-card p-6 rounded-2xl space-y-3">
                                    ...
                                    <h4 className="text-base font-bold text-white">Privacy by Math</h4>
                                    <p className="text-xs text-slate-400 leading-relaxed">
                ...
                {activeTab === 'security' && (
                    <section className="space-y-12 animate-fadeIn">
                        ...
                        <div className="space-y-6 text-slate-300 text-base leading-relaxed">
                            ...
                            <h2 className="text-2xl font-bold text-white pt-2">Ba Tầng Bảo Vệ Toàn Diện</h2>

                            {/* Layer 1 */}
                            <div className="glass-card p-6 sm:p-7 rounded-2xl space-y-4 border-l-4 border-l-cyan-400">
                                <div className="flex items-center gap-3">
                                    <span className="px-2.5 py-1 rounded-lg text-xs font-mono font-bold bg-cyan-500/20 text-cyan-300">TẦNG 1</span>
                                    <h3 className="text-lg font-bold text-white">Truyền trực tiếp Peer-to-Peer (WebRTC DataChannel)</h3>
                                </div>
                            ...
                            {/* Layer 2 */}
                            <div className="glass-card p-6 sm:p-7 rounded-2xl space-y-4 border-l-4 border-l-blue-400">
                                <div className="flex items-center gap-3">
                                    <span className="px-2.5 py-1 rounded-lg text-xs font-mono font-bold bg-blue-500/20 text-blue-300">TẦNG 2</span>
                                    <h3 className="text-lg font-bold text-white">Mạng lưới Swarm Sharing &amp; Băm toàn vẹn (BitTorrent Web)</h3>
                                </div>
                                <p className="text-sm text-slate-300 leading-relaxed">
                            ...
                            {/* Layer 3 */}
                            <div className="glass-card p-6 sm:p-7 rounded-2xl space-y-4 border-l-4 border-l-emerald-400">
                                <div className="flex items-center gap-3">
                                    <span className="px-2.5 py-1 rounded-lg text-xs font-mono font-bold bg-emerald-500/20 text-emerald-300">TẦNG 3</span>
                                    <h3 className="text-lg font-bold text-white">Lưu tạm E2EE (Client-Side Encryption) &amp; Tự hủy (Burn)</h3>
                                </div>
                                <div className="text-sm text-slate-300 space-y-3 leading-relaxed">
                                    <p>Khi người nhận chưa online, bạn có thể chọn chế độ <strong>Lưu tạm E2EE</strong>:</p>
                                    <ul className="list-disc list-inside space-y-2 text-slate-300 pl-2">
                                        <li><strong className="text-white">Mã hóa ngay trên RAM máy bạn:</strong> Trình duyệt sử dụng hàm <code>PBKDF2</code> (100,000 vòng lặp) và thuật toán <code>AES-256-GCM</code> thông qua chuẩn Web Crypto API. File biến thành bản mã vô nghĩa (.enc) trước khi gửi lên server.</li>
                                        <li><strong className="text-white">Đường link chứa Chìa khóa (#hash):</strong> Mật khẩu giải mã được đặt ở phần URL hash (sau dấu <code>#</code>). Theo chuẩn RFC 3986, trình duyệt <em>không bao giờ gửi nội dung sau dấu # lên máy chủ</em>. Do đó máy chủ không có chìa khóa để mở file.</li>
                                        <li><strong className="text-white">Cơ chế Tự hủy (Burn After Reading &amp; TTL):</strong> File sẽ tự động bị xóa sạch khỏi máy chủ sau khi hết hạn (1h, 6h, 12h, 24h) hoặc xóa ngay lập tức sau 1 lần tải thành công duy nhất.</li>
                                    </ul>
                                </div>
                            </div>
                            ...
                            {/* Transparency Table */}
                            <div className="pt-6">
                                <h3 className="text-xl font-bold text-white mb-4">Minh bạch: Chúng tôi biết gì và không biết gì?</h3>
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    <div className="glass-card p-6 rounded-2xl border-emerald-500/20 bg-emerald-950/10">
                                        <div className="text-xs uppercase tracking-wider font-mono font-bold text-emerald-400 mb-2 flex items-center gap-1.5">
                                    ...
                                    <div className="glass-card p-6 rounded-2xl border-cyan-500/20 bg-cyan-950/10">
                                        <div className="text-xs uppercase tracking-wider font-mono font-bold text-cyan-400 mb-2 flex items-center gap-1.5">
                        ...
                        <div className="space-y-8 text-slate-300 text-sm leading-relaxed">
                            <div className="glass-card p-6 sm:p-8 rounded-2xl space-y-4">
                                <h3 className="text-xl font-bold text-white flex items-center gap-2">
                                    <span className="w-7 h-7 rounded-lg bg-cyan-500/20 text-cyan-400 inline-flex items-center justify-center text-xs font-mono font-bold">1</span>
                            ...
                            <div className="glass-card p-6 sm:p-8 rounded-2xl space-y-4">
                                <h3 className="text-xl font-bold text-white flex items-center gap-2">
                                    <span className="w-7 h-7 rounded-lg bg-blue-500/20 text-blue-400 inline-flex items-center justify-center text-xs font-mono font-bold">2</span>
                            ...
                            <div className="glass-card p-6 sm:p-8 rounded-2xl space-y-4">
                                <h3 className="text-xl font-bold text-white flex items-center gap-2">
                                    <span className="w-7 h-7 rounded-lg bg-indigo-500/20 text-indigo-400 inline-flex items-center justify-center text-xs font-mono font-bold">3</span>
                ...
                {activeTab === 'roadmap' && (
                    <section className="space-y-12 animate-fadeIn">
                        <div className="space-y-4">
                            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full text-xs font-medium bg-purple-500/10 text-purple-400 border border-purple-500/20">
                        ...
                        <div className="relative pl-6 sm:pl-10 space-y-10 timeline-line">
                            {/* Stage 1 */}
                            <div className="relative space-y-3">
                                <div className="absolute -left-[35px] sm:-left-[51px] top-1.5 w-6 h-6 rounded-full bg-cyan-500 border-4 border-[#05070d] flex items-center justify-center shadow-glow">
                                    <div className="w-2 h-2 rounded-full bg-white animate-ping"></div>
                                </div>
                                <div>
                                    <span className="inline-flex items-center px-2.5 py-0.5 rounded-full text-[11px] font-mono font-semibold bg-cyan-500/20 text-cyan-300 border border-cyan-500/30">
                                        HIỆN TẠI — ĐÃ HOÀN THÀNH
                                    </span>
                                    <h3 className="text-xl font-bold text-white mt-1">Giai đoạn 1: Nền tảng cốt lõi (The MVP)</h3>
                                </div>
                                <p className="text-sm text-slate-400 leading-relaxed">
                                    Tập trung tối đa vào độ ổn định kết nối, truyền tải dữ liệu nguyên bản và kiến trúc Zero-Knowledge.
                                </p>
                                <ul className="text-xs text-slate-300 space-y-2 glass-card p-4 rounded-xl">
                                    <li className="flex items-center gap-2 text-cyan-300">
                                        <svg className="w-4 h-4 text-cyan-400 shrink-0" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="3"><polyline points="20 6 9 17 4 12"/></svg>
                            ...
                            {/* Stage 2 */}
                            <div className="relative space-y-3">
                                <div className="absolute -left-[35px] sm:-left-[51px] top-1.5 w-6 h-6 rounded-full bg-blue-500 border-4 border-[#05070d]"></div>
                                <div>
                                    <span className="inline-flex items-center px-2.5 py-0.5 rounded-full text-[11px] font-mono font-semibold bg-blue-500/20 text-blue-300 border border-blue-500/30">
                                        KẾ HOẠCH — QUÝ TIẾP THEO
                                    </span>
                                    <h3 className="text-xl font-bold text-white mt-1">Giai đoạn 2: Tự động phục hồi &amp; Chia sẻ Thư mục</h3>
                                </div>
                                <p className="text-sm text-slate-400 leading-relaxed">
                            ...
                            {/* Stage 3 */}
                            <div className="relative space-y-3">
                                <div className="absolute -left-[35px] sm:-left-[51px] top-1.5 w-6 h-6 rounded-full bg-indigo-500 border-4 border-[#05070d]"></div>
                                <div>
                                    <span className="inline-flex items-center px-2.5 py-0.5 rounded-full text-[11px] font-mono font-semibold bg-indigo-500/20 text-indigo-300 border border-indigo-500/30">
                                        NĂM 2027
                                    </span>
                                    <h3 className="text-xl font-bold text-white mt-1">Giai đoạn 3: Đa nền tảng &amp; Ứng dụng Chuyên dụng</h3>
                                </div>
                                <p className="text-sm text-slate-400 leading-relaxed">
                            ...
                            {/* Stage 4 */}
                            <div className="relative space-y-3">
                                <div className="absolute -left-[35px] sm:-left-[51px] top-1.5 w-6 h-6 rounded-full bg-slate-700 border-4 border-[#05070d]"></div>
                                <div>
                                    <span className="inline-flex items-center px-2.5 py-0.5 rounded-full text-[11px] font-mono font-semibold bg-slate-800 text-slate-400 border border-slate-700">
                                        TẦM NHÌN DÀI HẠN
                                    </span>
                                    <h3 className="text-xl font-bold text-white mt-1">Giai đoạn 4: Hệ sinh thái Phi tập trung &amp; Self-Hosted</h3>
                                </div>
                                <p className="text-sm text-slate-400 leading-relaxed">
            ...
            <nav className="fixed bottom-4 sm:bottom-6 left-1/2 -translate-x-1/2 z-50 w-[95%] max-w-2xl">
                <div className="glass-dock rounded-full px-2 py-1.5 sm:px-3 sm:py-2 flex items-center justify-between shadow-2xl">
                    <div className="flex items-center gap-1 overflow-x-auto no-scrollbar py-0.5">
                        <button
                            onClick={() => switchTab('transfer')}
                            className={`px-3 py-1.5 rounded-full text-xs font-semibold transition-all duration-200 whitespace-nowrap flex items-center gap-1.5 ${
                                activeTab === 'transfer'
                                    ? 'text-cyan-300 bg-cyan-500/15 border border-cyan-500/30 shadow-glow'
                        ...
                        <button
                            ...
                            className={`px-3 py-1.5 rounded-full text-xs font-medium transition-all duration-200 whitespace-nowrap ${
                                activeTab === 'about'
                                    ? 'text-cyan-300 bg-cyan-500/15 border border-cyan-500/30 shadow-glow font-semibold'
                                    : 'text-slate-400 hover:text-white hover:bg-white/5'
                            }`}
                        >
                            Về chúng tôi
                    ...
                    <div className="flex items-center gap-2 pl-2 border-l border-white/10 shrink-0">
                        <button
                            ...
                            className="flex items-center gap-1.5 px-2 py-1 rounded-full text-xs text-slate-300 hover:text-white hover:bg-white/5 transition-colors"
                            title="Ngôn ngữ"
                        >
